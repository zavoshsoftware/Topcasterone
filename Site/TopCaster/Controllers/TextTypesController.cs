...
namespace TopCaster.Controllers
{
    ...
    public class TextTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] TextType textType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] TextType textType)
        {
            if (ModelState.IsValid)
            {
				textType.IsDeleted=false;
